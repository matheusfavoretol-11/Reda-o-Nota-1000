...
export const EBOOK_PAGES = [
  ...
  { p: 40, section: "TECNICA", title: "A Jornada Final", content: "Você agora possui o mapa completo. A teoria está em suas mãos, mas o 1000 está na ponta do seu lápis. Pratique. Escreva. Erre. Melhore. O sucesso na redação do ENEM é uma escada que se sobe um de cada vez. Confie no método Red 1000 Pro e na nossa IA Malu. Estamos aqui para garantir que sua voz seja ouvida e sua nota seja máxima. O seu futuro na universidade começa com o primeiro parágrafo que você escrever hoje. Boa jornada!" }
];

export const REPERTORIOS_DATA = [
  {
  ...
  },
  {
    ...
    items: [
      { name: "Educação (IBGE)", concept: "Evasão Escolar", application: "1,5 milhão de crianças fora da escola. Brasil investe 3,5% do PIB (OECD recomenda 6%).", themes: ["Dados"] },
      { name: "Violência (FBSP)", concept: "Taxas Reais", application: "45 mil homicídios/ano. 88% da violência sexual registrada ocorre em âmbito doméstico.", themes: ["Dados"] },
      { name: "Pobreza (IPEA)", concept: "Concentração", application: "62 milhões em pobreza. O top 1% ganha 550x mais que o bottom 50%.", themes: ["Dados"] },
      { name: "Saúde Mental (OMS)", concept: "Pandemia de Ansiedade", application: "Brasil é o país mais ansioso do mundo (9,3%) e 15% têm depressão.", themes: ["Dados"] },
      { name: "Meio Ambiente (IPCC)", concept: "Aquecimento Global", application: "Amazônia perdeu 22% em 30 anos. Limite seguro de 1.5°C está próximo.", themes: ["Dados"] }
    ]
  }
];

export const TOP_THEMES_REPERTOIRE = [
